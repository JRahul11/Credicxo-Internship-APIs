...
INSTALLED_APPS = [
    ...
    'auth_app',                                     # To use the auth_app
    'api_app',                                      # To use the api_app
]
...
ROOT_URLCONF = 'credicxo_project.urls'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=10),                         # Set every JWT Token to expire after 10 minutes
